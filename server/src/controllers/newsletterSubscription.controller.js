...
exports.createNewsletterSubscription = async (req, res) => {
    try {
        ...
        const createNewsletterSubscription = await NewsletterSubscription.create(data)
...
exports.getNewsletterSubscriptions = (req, res) => {
    NewsletterSubscription.find({}).exec()
    .then(result => {
        res.json(result);
    })
    .catch(error => {
...
exports.getNewsletterSubscriptionById = (req, res) => {
    NewsletterSubscription.findOne({'_id': req.params.id}).exec()
    .then(result => {
        res.json(result);
    })
    .catch(error => {
